<article id="post-<?php the_ID(); ?>" <?php post_class( 'entry-wrapper entry-wrapper-single' ); ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">  
